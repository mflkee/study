...
На этом этапе Rust перестаёт быть просто языком “про переменные и функции” и становится языком моделирования предметной области.
...
Это почти всегда лучше, чем хранить приоритет строкой `"high"` и надеяться, что никто не ошибётся в буквах.
...
Во многих учебных курсах после базового синтаксиса идут классы и наследование. В Rust вместо этого обычно используют:
...
- Домашнее: [2.2 Структуры, enum, методы и traits](../Домашние%20задания/2.2%20Структуры,%20enum,%20методы%20и%20traits/README.md)
